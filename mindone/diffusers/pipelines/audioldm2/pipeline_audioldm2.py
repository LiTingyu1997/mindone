...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> pipe = AudioLDM2Pipeline.from_pretrained(repo_id, mindspore_dtype=ms.float16)
...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    def generate_language_model(
        ...
        **model_kwargs,
        ...
        for _ in range(max_new_tokens):
            ...
            inputs_embeds = ops.cat([inputs_embeds, next_hidden_states[:, -1:, :]], axis=1)
    ...
    def encode_prompt(
        ...
        generated_prompt_embeds: Optional[Tensor] = None,
        negative_generated_prompt_embeds: Optional[Tensor] = None,
        ...
        Args:
            ...
            generated_prompt_embeds (`Tensor`, *optional*):
                Pre-generated text embeddings from the GPT2 langauge model. Can be used to easily tweak text inputs,
                 *e.g.* prompt weighting. If not provided, text embeddings will be generated from `prompt` input
                 argument.
            negative_generated_prompt_embeds (`Tensor`, *optional*):
            ...
            negative_attention_mask (`Tensor`, *optional*):
        ...
        Returns:
            ...
            generated_prompt_embeds (`Tensor`):
        ...
        attention_mask = (
            ...
            else ops.ones(prompt_embeds.shape[:2], dtype=ms.int64)
        )
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None:
            ...
            for tokenizer, text_encoder in zip(tokenizers, text_encoders):
                ...
                if text_encoder.config.model_type == "clap":
                    ...
                    negative_prompt_embeds = ops.zeros(
                        batch_size,
                        tokenizer.model_max_length,
                        text_encoder.config.hidden_size,
                    ).to(dtype=self.text_encoder_2.dtype)
                    negative_attention_mask = ops.zeros(batch_size, tokenizer.model_max_length).to(
        ...
        if do_classifier_free_guidance:
            ...
            negative_attention_mask = (
                ...
                else ops.ones(negative_prompt_embeds.shape[:2], dtype=ms.int64)
            )
            ...
            generated_prompt_embeds = ops.cat([negative_generated_prompt_embeds, generated_prompt_embeds])
    ...
    def __call__(
        ...
        Args:
            ...
            callback (`Callable`, *optional*):
                ...
                following arguments: `callback(step: int, timestep: int, latents: Tensor)`.
            ...
            output_type (`str`, *optional*, defaults to `"np"`):
                ...
                `"pt"` to return a mindspore `Tensor` object. Set to `"latent"` to return the latent diffusion
                model (LDM) output.
