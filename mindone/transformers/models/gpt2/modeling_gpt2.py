...
class GPT2Attention(nn.Cell):
    ...
    def _upcast_and_reordered_attn(self, query, key, value, attention_mask=None, head_mask=None):
        ...
        attn_weights = ops.zeros((bsz * num_heads, q_seq_len, k_seq_len), dtype=ms.float32)
    ...
    def construct(
        ...
        layer_past: Optional[Tuple[ms.Tensor]] = None,
...
class GPT2PreTrainedModel(MSPreTrainedModel):
    """
...
class GPT2DoubleHeadsModelOutput(ModelOutput):
    ...
    mc_loss: Optional[ms.Tensor] = None
    logits: ms.Tensor = None
    mc_logits: ms.Tensor = None
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        head_mask: Optional[ms.Tensor] = None,
        inputs_embeds: Optional[ms.Tensor] = None,
        mc_token_ids: Optional[ms.Tensor] = None,
        labels: Optional[ms.Tensor] = None,
        mc_labels: Optional[ms.Tensor] = None,
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
