...
class PhiAttention(nn.Cell):
    ...
    def __init__(self, config: PhiConfig, layer_idx: int):
        ...
        self.k_proj = mint.nn.Linear(config.hidden_size, config.num_key_value_heads * self.head_dim, bias=True)
        self.v_proj = mint.nn.Linear(config.hidden_size, config.num_key_value_heads * self.head_dim, bias=True)
        self.dense = mint.nn.Linear(config.num_attention_heads * self.head_dim, config.hidden_size, bias=True)
...
class PhiPreTrainedModel(MSPreTrainedModel):
...
class PhiForCausalLM(PhiPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.vocab_size = config.vocab_size
        self.lm_head = mint.nn.Linear(config.hidden_size, config.vocab_size, bias=True)
