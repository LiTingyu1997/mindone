...
class WhisperPositionalEmbedding(Embedding):
...
class WhisperPreTrainedModel(MSPreTrainedModel):
    ...
    def _init_weights(self, cell):
        ...
        elif isinstance(cell, Embedding):
...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.embed_positions = Embedding(self.max_source_positions, embed_dim)
...
class WhisperDecoder(WhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.embed_tokens = Embedding(config.vocab_size, config.d_model, padding_idx=self.padding_idx)
